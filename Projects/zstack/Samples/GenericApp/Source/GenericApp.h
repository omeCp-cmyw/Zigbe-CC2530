...
#define GENERICAPP_END          2
#define GENERICAPP_ROT     3
#define SAMPLEAPP_Guangqiang_CLUSTERID   4

// Send Message Timeout
#define GENERICAPP_SEND_MSG_TIMEOUT  1500     // Every 500 mseconds
#define GENERICAPP_SEND_MSG_TIMEOUT_1 800
